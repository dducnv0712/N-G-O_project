...
;(function() {
  ...
  var runInContext = (function runInContext(context) {
    ...
    /** Used to detect profile, sets, and weakmaps. */
    ...
    // Fallback for data views, profile, sets, and weak profile in IE 11 and promises in Node.js < 6.
     ...
     * and supports cloning arrays, array buffers, booleans, date objects, profile,
     ...
     * Similarly, profile and sets are considered empty if they have a `size` of `0`.
     *
     * @static
     * @memberOf _
     * @since 0.1.0
     ...
     * date objects, error objects, profile, numbers, `Object` objects, regexes,
