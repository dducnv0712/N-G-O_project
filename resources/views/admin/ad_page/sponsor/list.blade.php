...
@section('main')
    <div class="container-fluid p-0">
        ...
        <div class="card">
            <div class="card-body">
                <table class="table" id="dataTable-sponsor">
                    <thead>
                    <tr>
                    ...
                    @foreach($sponsor as $item)
                        <tr>
                            ...
                            <td>
                                @if($item->active == 0)
                                    <a href="{{url('admin/sponsor/active',["id"=>$item->id])}}"><i class="align-middle text-success" data-feather="eye"></i></a>
                                @else
                                    <a href="{{url('admin/sponsor/active',["id"=>$item->id])}}"><i class="align-middle text-danger" data-feather="eye-off"></i></a>
                                @endif
                            </td>
                            ...
                            <td class="table-action">
                                        ...
                                        <div class="modal-content">
                                            <form  action="{{url('admin/category/update',["id"=>$item->id])}}" method="post">
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        <label for="title" class="form-label fw-bold">{{__('Nhà tài trợ')}}</label>
                                ...
                                <a href="javascript:void(0)"  onclick="deleteSponsor({{$item->id}})"><i class="align-middle" data-feather="trash"></i></a>
                            </td>
                        </tr>
    ...
    <div class="modal fade" id="addCate" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form method="POST" action="{{url('/admin/sponsor/save')}}" >
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Modal title</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">X</button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                               <span class="input-group-btn">
                                 <a id="sponsor-upload" data-input="thumbnail-gallery" data-preview="holder-gallery" class="btn btn-primary">
                                   <i class="fa fa-picture-o"></i> Choose
                                 </a>
                               </span>
