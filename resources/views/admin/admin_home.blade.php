                ...
                <div class="w-100">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title mb-4">{{__('Tổng Số Dự Án')}}</h5>
                                    <h1 class="mt-1 mb-3">{{count($post)}}</h1>
                                    <div class="mb-1">
                                        <span class="text-muted">{{__('Dự Án')}}</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="w-100">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title mb-4">{{__('Dự Án Đang Nhận Đóng Góp')}}</h5>
                                    <h1 class="mt-1 mb-3">{{count($post) - count($count_contribute)}}</h1>
                                    <div class="mb-1">
                                        <span class="text-muted">{{__('Dự Án')}}</span>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title mb-4">{{__('Liên Hệ Đang Chờ')}}</h5>
                                    <h1 class="mt-1 mb-3">{{count($contact)}}</h1>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title mb-4">{{__('Tinh Nguyện Viên')}}</h5>
                                    <h1 class="mt-1 mb-3">{{count($volunteer)}}</h1>
                                    <div class="mb-1">
                                        <span class="text-muted">{{__('Thành Viêm')}}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title mb-4">{{__('Nhận Tin Tức Mới')}}</h5>
                                    <h1 class="mt-1 mb-3">{{count($newsletter)}}</h1>
                                </div>
                            </div>
            ...
            <div class="col-12 col-md-12 col-xxl-8 d-flex order-3 order-xxl-2">
                <div class="card flex-fill w-100">
                    <div class="card-header">
                        ...
                        <h5 class="card-title mb-0">{{__('Bản Đồ Phân Bố Của Tổ Chức')}}</h5>
                    </div>
            ...
            <div class="col-12 col-md-6 col-xxl-4 d-flex order-1 order-xxl-1">
                <div class="card flex-fill">
                    <div class="card-header">
                        ...
                        <h5 class="card-title mb-0">{{__('Lịch Vạn Niên')}}</h5>
                    </div>
